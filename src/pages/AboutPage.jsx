      ...
      <div style={{
        ...
        <div className="container">
          ...
          <p style={{ fontSize: '1.15rem', color: 'var(--text-muted)', maxWidth: '820px', lineHeight: 1.6 }}>
            Muhammed Ameen provides transparent, unbiased advisory across India's premier health and life insurance companies — ensuring your family gets maximum coverage with zero hidden capping.
          </p>
        </div>
      </div>
