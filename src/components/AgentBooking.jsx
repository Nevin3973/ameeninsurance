      ...
      <div className="container">
        <div style={{ textAlign: 'center', maxWidth: '680px', margin: '0 auto 2.5rem' }}>
          <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', marginBottom: '0.6rem' }}>
            Book Consultation with Muhammed Ameen
          </h2>
          <p style={{ color: 'var(--text-muted)', fontSize: '1.05rem' }}>
            Schedule a 1-on-1 session to evaluate health coverage options or compare partner policies.
          </p>
        </div>
        ...
        {!bookingConfirmed ? (
            ...
            <form onSubmit={handleBookingSubmit}>
              <div style={{ marginBottom: '1.5rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.8rem' }}>
                  ...
                  >
                    <Building size={18} /> Office Meeting
                  </button>
                </div>
              </div>
          ...
          <div className="clean-card" style={{ maxWidth: '520px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <h3 style={{ fontSize: '1.4rem', marginBottom: '0.4rem' }}>Consultation Confirmed!</h3>
            <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem', fontSize: '0.9rem' }}>
              Muhammed Ameen will connect with you on <strong>{selectedDate}</strong> at <strong>{selectedTimeSlot}</strong> via {meetingType === 'video' ? 'Google Meet Video Call' : 'Office Meeting'}.
            </p>
